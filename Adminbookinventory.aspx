<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Adminbookinventory.aspx.cs" Inherits="_Default" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <label>
                                    Book Name</label>
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Bookname"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <label>
                                        Issued Books</label>
                                    <div class="form-group">
                                        <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Pages"
                                            TextMode="SingleLine" ReadOnly="True"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
